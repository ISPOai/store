...
export function TabBar() {
	...
	return (
		<div className="relative flex h-full flex-col items-center p-1 gap-1">
			<div className="relative flex min-h-0 flex-1 w-full">
				<div
					ref={scrollRef}
					className="scrollbar-hidden relative flex size-full flex-col items-center justify-start gap-0.5 overflow-y-auto"
				>
					{TAB_KEYS.map((tabKey) => {
