...
const EXCALIDRAW_PLUS_ORIGIN = (globalThis.__ISPO_ENV||(globalThis.__ISPO_ENV={MODE:"production",PROD:true,DEV:false,SSR:false})).VITE_APP_PLUS_APP;
        ...
        try {
          try {
            await verifyJWT({
              ...
              publicKey: (globalThis.__ISPO_ENV||(globalThis.__ISPO_ENV={MODE:"production",PROD:true,DEV:false,SSR:false})).VITE_APP_PLUS_EXPORT_PUBLIC_KEY,
            });
          } catch (error: any) {
