...
const SENTRY_DISABLED = (globalThis.__ISPO_ENV||(globalThis.__ISPO_ENV={MODE:"production",PROD:true,DEV:false,SSR:false})).VITE_APP_DISABLE_SENTRY === "true";
...
Sentry.init({
  ...
  release: (globalThis.__ISPO_ENV||(globalThis.__ISPO_ENV={MODE:"production",PROD:true,DEV:false,SSR:false})).VITE_APP_GIT_SHA,
  ignoreErrors: [
