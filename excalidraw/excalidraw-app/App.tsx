...
> => {
  ...
  // ISPO: force a transparent canvas background, always. Excalidraw must not
  // paint its own canvas fill — the host chrome shows through instead. This
  // overrides any persisted viewBackgroundColor (incl. the prior white default).
  scene.appState.viewBackgroundColor = COLOR_PALETTE.transparent;
  ...
  useEffect(() => {
    const unloadHandler = (event: BeforeUnloadEvent) => {
      ...
      if (
        ...
        if ((globalThis.__ISPO_ENV||(globalThis.__ISPO_ENV={MODE:"production",PROD:true,DEV:false,SSR:false})).VITE_APP_DISABLE_PREVENT_UNLOAD !== "true") {
          preventUnload(event);
        } else {
          console.warn(
    ...
    >
      <Excalidraw
        ...
        UIOptions={{
          canvasActions: {
            toggleTheme: true,
            // ISPO build: canvas is force-transparent; hide the background picker.
            changeViewBackgroundColor: false,
            // ISPO build: the only way out of the editor is "Export to ISPO".
            // Disable every local-file / shareable-link export path.
      ...
      >
        ...
        <OverwriteConfirmDialog>
          {excalidrawAPI && (
            ...
            >
              {t("overwriteConfirm.action.ispo.description")}
            </OverwriteConfirmDialog.Action>
          )}
        </OverwriteConfirmDialog>
        ...
        <CommandPalette
          customCommandPaletteItems={[
            ...
            {
              label: t("exportDialog.ispo_scene_title"),
              category: DEFAULT_CATEGORIES.export,
              icon: exportToPlus,
              predicate: true,
              keywords: ["ispo", "export", "save", "scene", "png", "image"],
              perform: () => {
                excalidrawAPI?.updateScene({
