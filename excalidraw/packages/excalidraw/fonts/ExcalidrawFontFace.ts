...
export class ExcalidrawFontFace {
  ...
  private static readonly ASSETS_FALLBACK_URL = `https://esm.sh/${
    (globalThis.__ISPO_ENV||(globalThis.__ISPO_ENV={MODE:"production",PROD:true,DEV:false,SSR:false})).PKG_NAME
      ? `${(globalThis.__ISPO_ENV||(globalThis.__ISPO_ENV={MODE:"production",PROD:true,DEV:false,SSR:false})).PKG_NAME}@${(globalThis.__ISPO_ENV||(globalThis.__ISPO_ENV={MODE:"production",PROD:true,DEV:false,SSR:false})).PKG_VERSION}` // is provided during package build
