...
export const isTestEnv = () => (globalThis.__ISPO_ENV||(globalThis.__ISPO_ENV={MODE:"production",PROD:true,DEV:false,SSR:false})).MODE === ENV.TEST;

export const isDevEnv = () => (globalThis.__ISPO_ENV||(globalThis.__ISPO_ENV={MODE:"production",PROD:true,DEV:false,SSR:false})).MODE === ENV.DEVELOPMENT;

export const isProdEnv = () => (globalThis.__ISPO_ENV||(globalThis.__ISPO_ENV={MODE:"production",PROD:true,DEV:false,SSR:false})).MODE === ENV.PRODUCTION;
