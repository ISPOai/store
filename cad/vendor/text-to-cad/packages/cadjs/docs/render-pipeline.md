...
It does not write files. Upstream's optional snapshot CLI writes the returned
data to disk. This app omits that CLI and captures the embedded viewer canvas
through its host-mediated Files workflow.
