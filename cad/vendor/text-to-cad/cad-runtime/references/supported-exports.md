...
Read this file when the user requests STL, 3MF, or native GLB output from CAD geometry. Two-dimensional DXF authoring is outside this app runtime's supported workflow.
