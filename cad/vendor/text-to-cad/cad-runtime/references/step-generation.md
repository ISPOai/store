...
Every `scripts/step` run also writes hidden adjacent GLB/topology artifacts as part of the normal build. They power the embedded CAD viewer and `scripts/inspect` refs, and are not optional in the STEP workflow.
