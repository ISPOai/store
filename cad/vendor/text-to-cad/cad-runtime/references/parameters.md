...
Use the embedded viewer's explicit `snapshot.png` for visual semantics, following `snapshot-review.md`:

- Review the generated pose captured for the run; request another bounded run when a distinct pose needs review.
