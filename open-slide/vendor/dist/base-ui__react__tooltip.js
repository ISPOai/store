...
if (false) FloatingDelayGroupContext.displayName = "FloatingDelayGroupContext";
...
var TooltipRoot = fastComponent(function TooltipRoot2(props) {
  ...
  return /* @__PURE__ */ _jsxs2(TooltipRootContext.Provider, {
    value: store,
    children: [shouldRenderInteractions && /* @__PURE__ */ _jsx4(TooltipInteractions, {
      store,
      disabled: disabled2,
      trackCursorAxis
...
if (false) TooltipRoot.displayName = "TooltipRoot";
...
// node_modules/.pnpm/@base-ui+react@1.6.0_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@base-ui/react/tooltip/utils/constants.mjs
var OPEN_DELAY = 600;
...
var TooltipTrigger = fastComponentRef(function TooltipTrigger2(componentProps, forwardedRef) {
  ...
  if (!store) {
    throw new Error(false ? "Base UI: <Tooltip.Trigger> must be either used within a <Tooltip.Root> component or provided with a handle." : formatErrorMessage_default(82));
  }
...
if (false) FloatingPortalLite.displayName = "FloatingPortalLite";
...
var TooltipPortal = /* @__PURE__ */ React34.forwardRef(function TooltipPortal2(props, forwardedRef) {
  ...
  return /* @__PURE__ */ _jsx5(TooltipPortalContext.Provider, {
    value: keepMounted,
    children: /* @__PURE__ */ _jsx5(FloatingPortalLite, {
      ref: forwardedRef,
      ...portalProps
    })
  });
...
var TooltipPositioner = /* @__PURE__ */ React38.forwardRef(function TooltipPositioner2(componentProps, forwardedRef) {
  ...
  return /* @__PURE__ */ _jsx6(TooltipPositionerContext.Provider, {
    value: positioning,
    children: element
  });
});
...
var TooltipProvider = function TooltipProvider2(props) {
  ...
  return /* @__PURE__ */ _jsx7(TooltipProviderContext.Provider, {
    value: contextValue,
    children: /* @__PURE__ */ _jsx7(FloatingDelayGroup, {
      delay: delayValue,
      timeoutMs: timeout,
...
function usePopupViewport(parameters) {
  ...
  if (!isTransitioning) {
    childrenToRender = /* @__PURE__ */ _jsx8("div", {
      "data-current": true,
...
if (false) TooltipViewport.displayName = "TooltipViewport";

// node_modules/.pnpm/@base-ui+react@1.6.0_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@base-ui/react/tooltip/store/TooltipHandle.mjs
var TooltipHandle = class {
  ...
  open(triggerId) {
    ...
    if (triggerId && !triggerElement) {
      throw new Error(false ? `Base UI: TooltipHandle.open: No trigger found with id "${triggerId}".` : formatErrorMessage_default(81, triggerId));
    }
