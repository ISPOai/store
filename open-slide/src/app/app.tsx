...
// Port seam: HashRouter, not BrowserRouter. A project iframe is served from
// project://<projectId>/ and a pushed path has no server to answer for it on
// reload, so history routing would 404 the app on refresh.
export function App() {
  return (
    <HashRouter>
