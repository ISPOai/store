...
> The provisional launch-audience shortlist and its gap analysis are tracked separately in [`launch-audience-shortlist-draft.md`](./launch-audience-shortlist-draft.md). It is not part of the approved landscape conclusions.
